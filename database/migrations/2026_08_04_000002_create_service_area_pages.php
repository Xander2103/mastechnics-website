...
return new class extends Migration
{
    ...
    private function createHub(): void
    {
        ...
        $rows = [
            [
                ...
                'meta_title' => 'Werkgebied – Druivenstreek & Brabant | Mastechnics',
            ...
            [
                ...
                'meta_title' => 'Zone d\'intervention – Druivenstreek | Mastechnics',
            ...
            [
                ...
                'meta_title' => 'Service area – Druivenstreek & Brabant | Mastechnics',
    ...
    private function createLocationPages(): void
    {
        ...
        $metaTitles = [
            ...
            'fr' => 'Chauffage, clim & sanitaire à :name | Mastechnics',
            'en' => 'Heating, aircon & plumbing in :name | Mastechnics',
        ];
        ...
        $metaDescriptions = [
            ...
            'fr' => 'Mastechnics, votre installateur chauffage, climatisation, sanitaire et ventilation à :name (:postal). Demandez un devis ou une intervention en ligne.',
            'en' => 'Mastechnics is your installer for heating, air conditioning, plumbing and ventilation in :name (:postal). Request a quote or call-out online.',
        ];
