...
$content = [
    'nl' => [
        ...
        'why_body'        => 'De gegevens worden uitsluitend gebruikt om je aanvraag correct te verwerken, een inschatting of offerte op te maken, en je te contacteren over de opvolging van je aanvraag.',
        ...
        'legal_note'      => 'Let op: deze tekst is een praktische samenvatting bedoeld voor de bezoekers van deze website. De juridisch definitieve versie dient te worden nagekeken door een professionele juridisch adviseur of GDPR-expert.',
    ],
    'fr' => [
        ...
        'legal_note'      => 'Remarque : ce texte est un résumé pratique destiné aux visiteurs de ce site. La version juridique définitive doit être vérifiée par un conseiller juridique professionnel ou un expert RGPD.',
    ],
    'en' => [
        ...
        'legal_note'      => 'Note: this text is a practical summary intended for visitors to this website. The final legal version should be reviewed by a professional legal adviser or GDPR expert.',
    ],
];
...
<section class="privacy-policy">
    <div class="container">
        ...
        {{-- NOTE FOR SITE OWNER: The text below is a practical summary. Have it reviewed by a legal/GDPR professional before launch. --}}
