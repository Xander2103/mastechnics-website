    ...
    public function run(): void
    {
        ...
        $home->translations()->createMany([
            [
                ...
                'content' => null,
                'meta_title' => '{{ $siteName }} | Technische service en interventies',
            ...
            [
                ...
                'content' => null,
                'meta_title' => '{{ $siteName }} | Service technique et interventions',
            ...
            [
                ...
                'content' => null,
                'meta_title' => '{{ $siteName }} | Technical service and interventions',
        ...
        $request->translations()->createMany([
            [
                ...
                'intro' => 'Vul stap voor stap de juiste informatie in over je installatie, probleem of project. Zo kan {{ $siteName }} sneller inschatten wat nodig is en indien mogelijk een richtprijs of duidelijke vervolgstap voorstellen.',
                'content' => null,
                'meta_title' => '{{ $siteName }} | Start aanvraag',
            ...
            [
                ...
                'intro' => 'Remplissez étape par étape les bonnes informations concernant votre installation, problème ou projet. {{ $siteName }} peut ainsi estimer plus rapidement ce qui est nécessaire et proposer une estimation ou une prochaine étape claire.',
                'content' => null,
                'meta_title' => '{{ $siteName }} | Démarrer une demande',
            ...
            [
                ...
                'intro' => 'Fill in the right information step by step about your installation, issue or project. This helps {{ $siteName }} estimate what is needed faster and provide an estimate or clear next step when possible.',
                'content' => null,
                'meta_title' => '{{ $siteName }} | Start request',
        ...
        $contact->translations()->createMany([
            [
                ...
                'meta_description' => 'Contacteer {{ $siteName }} via telefoon, e-mail, WhatsApp of het contactformulier.',
            ],
            [
                'locale' => 'fr',
                'slug' => 'contact',
                'title' => 'Contacter {{ $siteName }}',
                ...
                'content' => null,
                'meta_title' => '{{ $siteName }} | Contact',
                'meta_description' => 'Contactez {{ $siteName }} par téléphone, e-mail, WhatsApp ou via le formulaire de contact.',
            ],
            [
                'locale' => 'en',
                'slug' => 'contact',
                ...
                'content' => null,
                'meta_title' => '{{ $siteName }} | Contact',
                'meta_description' => 'Contact {{ $siteName }} by phone, email, WhatsApp or through the contact form.',
            ],
        ]);
